...
(function () {
        ...
        if (a) {
            ...
            var e = function (a) {
                a && (mb = o, setTimeout(function () {
                    nb.src = "plugins/baidu_new_t/images/blank.gif?"
                }, 50))
            }, f = function () {
                var a = ob.shift();
                a && e(a)
    ...
    var F = {
        ...
        $O: new L(12, 36),
        ZF: new L(13, 1),
        qa: "plugins/baidu_new_t/images/",
        e3: "plugins/baidu_new_t/images/",
        $F: "plugins/baidu_new_t/images/markers_new.png",
        YO: 24,
        ZO: 73,
        gC: {
    ...
    x.object.extend(I, {
                ...
                if (d.Bd == this.Fj.pG) {
                    ...
                    e.DC == q && (e.DC = o, setTimeout(function () {
                        ...
                        if(0 == a.length){
                            ...
                            for(var key in a){
                                // console.log('./js/getmodules/'+a[key]+'.js');
                                // Qb();
                                oa('./plugins/baidu_new_t/js/getmodules/'+a[key]+'.js')
                            }
                            // oa(e.iG.ZP + "&mod=" + a.join(","))
                        }
                    }, 1));
                    d.Bd = this.Fj.IP
                }
        ...
        lK: function (a) {
            if (a && this.qL()[a]) for (var a = this.qL()[a], b = 0; b < a.length; b++) this.lK(a[b]), this.Pd.ul[a[b]] || this.yN(a[b])
        },
        yN: function (a) {
            ...
            if (this.B) {
                ...
                switch (a) {
                    ...
                    case Vb:
                        c.style.bottom = e + "px";
                        c.style.left = d + "px";
                        c.innerHTML.indexOf('map.baidu.com') != -1?c.style.display = 'none':true;
                        c.innerHTML.indexOf('NavInfo') != -1?c.style.display = 'none':true;
                        c.innerHTML.indexOf('1100930') != -1?c.style.display = 'none':true;
                        break;
                    case 3:
    ...
    x.extend(Fc.prototype, {
        ra: function () {
            ...
            l = 0;
            for (d = this.Qc.length; l < d; l++) A = this.Qc[l][0], i = this.Qc[l][1], t = A * e + g[0] - c / 2, v = (-1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f, m = this.Tm[y], n = p, m ? (n = m.style, n.left = t + "px", n.top = v + "px", m.af || this.qn.push([A, i, m])) : (0 < this.Ne.length ? (m = this.Ne.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.Px() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = t + "px", n.top = v + "px", -1 < y.indexOf("bg") && (t = "#F3F1EC", this.map.K.Co && (t = this.map.K.Co), n.background = t ? t : ""), this.qn.push([A, i, m])), m.style.visibility = "";
            l = 0;
            ...
            if (a instanceof bb) b && a.Jm && (a.remove(), a.Jm = q); else {
                ...
                if (a.rp) for (var b = 0, c = this.Cg.length; b < c; b++) a == this.Cg[b] && this.Cg.splice(b, 1); else {
                    b = 0;
            ...
            if (!this.map.Wb() && (a ? this.map.K.u_ = a : a = this.map.K.u_, a)) for (var c = p, c = "2" == z.Qy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Nm[d]; d++) if (e.h_ == o) {
                ...
                e.getTilesUrl = function (b, d) {
                    return 'plugins/baidu_new_t/tiles/'+d+'/'+b.x+'/'+b.y+'.png';
    ...
    Yc.getTilesUrl = function (a, b, c) {
        return 'plugins/baidu_new_t/tiles/'+b+'/'+a.x+'/'+a.y+'.png';
    ...
    $c.getTilesUrl = function (a, b) {
        return 'plugins/baidu_new_t/satel/'+b+'/'+a.x+'/'+a.y+'.png';
        var c = a.x, d = a.y;
    ...
    Me.prototype = {
        ...
        refresh: function () {
            ...
            if ("string" == typeof this.options.du) {
                ...
                a = 0;
                for (b = c.length; a < b; a++) d = this.Zj(c[a]), d.left += this.VF, d.top += this.WF, this.Ue[a] = d.left < this.he ? this.he : d.left * this.scale, this.uf[a] = d.top < this.nd ? this.nd : d.top * this.scale
