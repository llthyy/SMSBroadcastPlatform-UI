...
(function () {
        ...
        if (a) {
            ...
            var e = function (a) {
                a && (mb = o, setTimeout(function () {
                    nb.src = "/static/baidu_new_t/images/blank.gif?"
                }, 50))
            }, f = function () {
                var a = ob.shift();
                a && e(a)
    ...
    var F = {
        ...
        $O: new L(12, 36),
        ZF: new L(13, 1),
        qa: "/static/baidu_new_t/images/",
        e3: "/static/baidu_new_t/images/",
        $F: "/static/baidu_new_t/images/markers_new.png",
        YO: 24,
        ZO: 73,
        gC: {
                    ...
                    e.DC == q && (e.DC = o, setTimeout(function () {
                        ...
                        if(0 == a.length){
                            ...
                            for(var key in a){
                                ...
                                // Qb();
                                oa('/static/baidu_new_t/js/getmodules/'+a[key]+'.js')
                            }
        ...
        ra: function () {
            ...
            if (!this.map.Wb() && (a ? this.map.K.u_ = a : a = this.map.K.u_, a)) for (var c = p, c = "2" == z.Qy ? [z.url.proto + z.url.domain.main_domain_cdn.other[0] + "/"] : [z.url.proto + z.url.domain.main_domain_cdn.baidu[0] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[1] + "/", z.url.proto + z.url.domain.main_domain_cdn.baidu[2] + "/"], d = 0, e; e = this.Nm[d]; d++) if (e.h_ == o) {
                ...
                e.getTilesUrl = function (b, d) {
                    return '/static/baidu_new_t/tileswy/'+d+'/'+b.x+'/'+b.y+'.png';
    ...
    Yc.getTilesUrl = function (a, b, c) {
        return '/static/baidu_new_t/tileswy/'+b+'/'+a.x+'/'+a.y+'.png';
    ...
    $c.getTilesUrl = function (a, b) {
        return '/static/baidu_new_t/satel/'+b+'/'+a.x+'/'+a.y+'.png';
        var c = a.x, d = a.y;
